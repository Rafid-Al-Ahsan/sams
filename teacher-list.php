...
<h3 class="header">Student Attendance Management System</h3>
    ...
    <nav class="navbar navbar-expand-sm bg-dark navbar-dark">
       ...
       <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link active" href="teacher-list.php">Teachers List</a>
        </li>
        <li class="nav-item">
...
<h2 style="text-align:center; margin: 15px 0;">All Teachers</h2>
  ...
  <div class="row">
    ...
    <table class="table table-striped table-hover">
     ...
     <?php
       ...
       $all_query = mysqli_query($conn, "SELECT * from teacher ORDER BY id asc");
